...
void main() {
  testWidgets('renders the Pencil F2 settings design', (tester) async {
    ...
    expect(find.text('字体与排版'), findsOneWidget);
    expect(find.text('字体、字号、行距和段距'), findsOneWidget);
    ...
    expect(find.text('添加、启用、更新和校验书源'), findsOneWidget);
    expect(find.text('8 个启用'), findsOneWidget);
