...
class _ReaderControlTheme {
  ...
  static const _night = _ReaderControlTheme._(
    overlay: _ReaderOverlayThemeTokens(
      barrier: Color(0x6B0F1013),
      glassHighlight: Color(0x0AFFFFFF),
      transparent: Colors.transparent,
    ),
    surface: _ReaderSurfaceThemeTokens(
      panel: Color(0xFF202126),
      panelHigh: Color(0xFF2B2D34),
      panelLow: Color(0xFF17181D),
      page: Color(0xFF111217),
      outline: Color(0xFF3B3E48),
      outlineStrong: Color(0xFF575B68),
      shadow: Color(0x660F1013),
      chromeShadow: Color(0x4D0F1013),
      sheetShadow: Color(0x590F1013),
    ),
    text: _ReaderTextThemeTokens(
      primary: Color(0xFFE3DED2),
      secondary: Color(0xFFA7A39B),
      tertiary: Color(0xFF858894),
      accentText: Color(0xFFF0E1B6),
      inverse: Color(0xFF111217),
      secondaryWeak: Color(0x66A7A39B),
    ),
    action: _ReaderActionThemeTokens(
      accent: Color(0xFFD4B46A),
      accentSoft: Color(0xFF4B3D25),
      darkFill: Color(0xFF111217),
      inactiveFill: Color(0xFF17181D),
      inactiveLine: Color(0xFF575B68),
      paperTexture: Color(0xFF26242A),
      whiteHighlight: Color(0xFFEDE6D7),
    ),
    themePicker: _ReaderThemePickerThemeTokens(
      paper: Color(0xFF24252B),
      panel: Color(0xFF202126),
      surfaceLow: Color(0xFF17181D),
      surfaceLine: Color(0xFF575B68),
      ink: Color(0xFFE3DED2),
      muted: Color(0xFFA7A39B),
      secondaryText: Color(0xFFC1BBB0),
      green: Color(0xFFD4B46A),
      greenSoft: Color(0xFF3B3223),
      greenLine: Color(0xFF6A5732),
      warmBrown: Color(0xFF6A5138),
      warmBrownLine: Color(0xFF8E744F),
    ),
  );
